  ...
  return (
    <div className="flex items-center gap-1.5">
      ...
      <button
        ...
        className="flex h-11 w-9 shrink-0 items-center justify-center rounded-[--radius-sm] border border-border bg-surface/60 text-faint transition-colors hover:text-accent disabled:opacity-40 motion-reduce:transition-none"
      >
