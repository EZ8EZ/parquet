...
function totalCount(r) {
  return (
    r.players.length + r.managers.length + r.trades.length + r.picks.length
  );
}
/**
 ...
 */
function mirrorToUrl(basePath, param, value) {
...
export function SearchPanel({ basePath, param = "q" }) {
