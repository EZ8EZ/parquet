 ...
 * intentional). Real NBA headshots are gated behind NEXT_PUBLIC_USE_PLAYER_PHOTOS
 * (default false) because NBA/Getty headshots are not licensed for
 * redistribution — see DECISIONS.md D8.
 */
...
const TEAM_COLORS: Record<string, [string, string]> = {
  ...
  UTA: ["#002B5C", "#00471B"], POR: ["#E03A3E", "#000000"], BKN: ["#000000", "#ffffff"],
...
export function PlayerAvatar({
  ...
  if (usePhotos && espnId) {
    // ESPN headshot CDN — personal/local use only (licensing caveat, D8).
    const src = `https://a.espncdn.com/i/headshots/nba/players/full/${espnId}.png`;
    return (
