  ...
  return (
    <div>
        ...
        {THEME_META.map((t) => {
          ...
          return (
            <button
              ...
              className="flex min-h-11 flex-col items-center justify-center gap-1 rounded-[--radius-sm] border border-border bg-surface px-2 py-2 text-meta font-semibold text-muted transition-colors hover:border-border-strong hover:text-ink motion-reduce:transition-none"
            >
      ...
      <ul className="mt-2 space-y-1">
        {THEME_META.map((t) => (
          <li key={t.id} className="text-meta leading-snug text-secondary">
