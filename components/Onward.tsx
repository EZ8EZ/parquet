...
export function Onward({
  ...
  /** The current path. Resolved against the registry. */
  from?: string;
  /** For surfaces with no registry entry of their own (a dynamic route, a Lab
   *  experiment): the steps, stated. */
  steps?: { href: string; label: string; why: string }[];
  className?: string;
}) {
