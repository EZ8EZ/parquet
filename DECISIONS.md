...
## D88. A YUI540-STYLE MOTION PASS - real research, three bounded interactions, one deliberate exception to the app's own "no spring" rule, and a WebGL option flagged rather than built
