...
## D104. THE RECORD GETS TYPOGRAPHY OF IMPORTANCE (VISION M6) - a season's headline deal as a box score, magnitude ticks on every row, and the receipt page's totals as a real two-sided receipt
