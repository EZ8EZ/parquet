...
const maskableSvg = Buffer.from(
  `<svg xmlns="http://www.w3.org/2000/svg" width="512" height="512">
     ...
     <g transform="translate(64 64) scale(0.75)">${readFileSync(
...
async function main() {
  ...
  await sharp(svg).resize(180, 180).png().toFile(resolve(pub, "icon-apple.png"));
  await sharp(maskableSvg).resize(512, 512).png().toFile(resolve(pub, "icon-maskable.png"));
