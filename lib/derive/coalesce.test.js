...
import { coalesceCommissionerTrades } from "./coalesce.js";
/**
...
describe("coalesceCommissionerTrades", () => {
  it("stitches commissioner rows into one multi-team trade", () => {
    const { transactions, reconstructed } =
      coalesceCommissionerTrades(threeTeamRows);
    ...
    expect(Object.keys(t.adds).sort()).toEqual([
      "1081",
      "1648",
      "1974",
      "2012",
