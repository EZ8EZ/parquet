 ...
 */
/**
 * Ids only, as described above — `TradeBuilder` resolves each one against
 * whichever player/pick pool the page hands it.
 * @typedef {Object} TradePackage
 * @property {string[]} give player ids you send
 * @property {string[]} get player ids you receive
 * @property {string[]} givePicks pick ids you send ("<season>-<round>-<originalRosterId>")
 * @property {string[]} getPicks pick ids you receive
 */
/** @type {TradePackage} */
