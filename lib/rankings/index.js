 ...
 */
export function consensusSource(players) {
  const ranks = new Map();
 ...
 */
export function customSource(orderedPlayerIds) {
  const ranks = new Map();
 ...
 */
export function blendSources(base, override, weight) {
 ...
 */
export function disagreements(custom, consensus, players) {
  const out = [];
 ...
 */
export function applyRanks(players, source) {
