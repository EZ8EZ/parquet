 ...
 * @param {{ valued: { value: number }[], window: string, coreAge?: number|null }} a a `leagueValueRanking` row
 * @param {number} valueRank
 * @param {number} teams
 * @returns {"contend"|"ascend"|"rebuild"|"retool"}
 */
...
/**
 * @param {{ rosterId: number, teamName?: string|null, ownerName?: string|null, byPosition: { pos: string, value: number }[], valued: { value: number }[], window: string, coreAge?: number|null }} a a `leagueValueRanking` row
 * @param {number} valueRank
 * @param {number} teams
 * @param {{ dossier?: { profile: { picks: { net: number }, overpaysForAge?: boolean, acquisitions: { avgAge: number|null } }, tags: string[] }, viewer?: boolean }} [opts]
 * @returns {Appetite}
 */
 ...
 * @param {{ rosterId: number, partnerRosterId: number, max?: number, customOrder?: string[] }} opts
 */
