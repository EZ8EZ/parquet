...
// The startable-ids projection lives with the other two post-trade reconstructions
// (lib/tradefinder/after.js) rather than here, where it was one of three private
// copies of "the roster, afterwards".
import { startableAfter } from "./after.js";
/**
 ...
 */
/**
 * One roster's single-point-of-failure read — who it hinges on, and how much.
 * Mirrors `spofOfPlayers`'s (lib/metrics/fragility.js) actual return shape.
 * @typedef {Object} SpofRead
 * @property {string} playerId
 * @property {string} name
 * @property {number} damage
 * @property {number} damageShare share of startable value lost if this player is out
 * @property {number} startableValue
 * @property {number} depthBeyondStarters startable count above replacement, minus lineup slots
 */
/**
 * @typedef {Object} FragilityNote
 * @property {"relieves"|"creates"} direction
 * @property {string} text
 * @property {SpofRead} before
 * @property {SpofRead} after
 */
/**
 ...
 */
/**
 * @param {SpofRead|null|undefined} before
 * @param {SpofRead|null|undefined} after
 * @returns {FragilityNote|null}
 */
 ...
 * @param {{ cfg?: ValuationConfig, replacementValue?: number }} [opts]
 * @returns {FragilityNote|null}
 */
export function packageFragilityNote(h, rosterId, give, get, opts = {}) {
  ...
  const after = spofOfPlayers(h, startableAfter(current, give, get), {
    cfg,
    replacementValue,
  });
