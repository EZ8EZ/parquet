...
// `byPositionAfter` was `applyPackageToByPosition` here. It moved, unchanged, to sit
// with the other two post-trade reconstructions - see lib/tradefinder/after.js.
import { byPositionAfter } from "./after.js";
/**
 ...
 */
/**
 * @typedef {Object} LeverageProfile
 * @property {number|null} score
 */
/**
 * @typedef {Object} LeverageShift
 ...
 */
/**
 * @param {LeverageProfile|null|undefined} before
 * @param {LeverageProfile|null|undefined} after
 * @param {Set<string>|null|undefined} touchedPositions
 * @returns {LeverageShift|null}
 */
 ...
 */
/**
 * `pools` is opaque here (`leaguePositionPools`'s own return, from the un-annotated
 * lib/lab/leverage — out of this pass's scope) and only ever passed through to
 * `buildLeverageProfile`, never read directly by this function.
 * @param {unknown} pools
 * @param {{ rosterId: number, teamName?: string|null, ownerName?: string|null, byPosition: PositionValue[] }|null|undefined} analysis
...
export function packageLeverageShift(pools, analysis, give, get) {
  ...
  const { byPosition: afterByPosition, touched } = byPositionAfter(
    analysis.byPosition,
    give,
    get,
  );
