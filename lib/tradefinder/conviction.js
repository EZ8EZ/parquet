import { consensusSource, customSource, disagreements } from "../rankings/index.js";
/**
 * @typedef {import('../trade/index.js').TradeAsset} TradeAsset
 * @typedef {import('../providers/types.js').Player} Player
 */
/**
 * @typedef {Object} ConvictionNote
 * @property {string} playerId
 * @property {string} name
 * @property {number} yourRank
 * @property {number} consensusRank
 * @property {number} gap
 * @property {boolean} above
 * @property {"get"|"give"} side
 * @property {"supports"|"questions"} verdict
 * @property {string} text
 */
/**
 * @typedef {Object} ConvictionSummary
 * @property {"supports"|"questions"} verdict
 * @property {string} text
 */
/**
 ...
 * @returns {Map<string, ReturnType<typeof disagreements>[number]>}
 */
 ...
 * @param {boolean} above
 * @param {"get"|"give"} side
 * @param {number} yourRank
 * @param {number} consensusRank
 * @returns {string}
 */
 ...
 */
/**
 * Assets typed narrowly to just `kind`/`id`/`label` — the only fields this function
 * reads (picks are skipped by `kind`, and it never needs an asset's `value`).
 * @param {{ get: Pick<TradeAsset, 'kind'|'id'|'label'>[], give: Pick<TradeAsset, 'kind'|'id'|'label'>[] }} pkg
 * @param {Map<string, ReturnType<typeof disagreements>[number]>} index
 * @param {{ minGap?: number, max?: number }} [opts]
 * @returns {ConvictionNote[]}
 */
 ...
 */
/**
 * @param {ConvictionNote[]} notes
 * @returns {ConvictionSummary|null}
 */
