...
export function fillerPlayers(count, startRank) {
  const out = [];
...
export const MANAGERS = [
  ...
  {
    displayName: "yagevlevi",
    teamName: "Hardwood Capital",
    archetype: "churner",
  },
  {
    displayName: "PickHoarder",
    teamName: "Future Assets",
    archetype: "hoarder",
  },
  { displayName: "SilentSam", teamName: "Do Not Disturb", archetype: "ghost" },
  { displayName: "TiltMachine", teamName: "Full Tilt", archetype: "panic" },
  {
    displayName: "NostalgiaGM",
    teamName: "Old Reliable",
    archetype: "name-chaser",
  },
  {
    displayName: "WaiverWade",
    teamName: "Wire Warriors",
    archetype: "streamer",
  },
  {
    displayName: "SteadyEddie",
    teamName: "The Process",
    archetype: "balanced",
  },
  ...
  {
    displayName: "EvenKeel",
    teamName: "Balanced Books",
    archetype: "balanced",
  },
];
