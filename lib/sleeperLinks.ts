 ...
 */
function isNumericId(id: string | null | undefined): id is string {
 ...
 */
export function sleeperLeagueUrl(leagueId: string | null | undefined): string | null {
 ...
 */
export function sleeperTeamUrl(
  leagueId: string | null | undefined,
  _rosterId?: number | string | null,
): string | null {
