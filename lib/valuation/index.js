...
export function ageMultiplier(age, cfg = VALUATION_CONFIG) {
...
export function valuePlayer(player, scoring, cfg = VALUATION_CONFIG, posMults) {
...
export function valuePlayers(players, scoring, cfg = VALUATION_CONFIG) {
  ...
  for (const p of players)
    out.set(p.playerId, valuePlayer(p, scoring, cfg, posMults));
  return out;
}
/**
