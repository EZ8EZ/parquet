...
import { getPrincipals, tenureLabel, tenureSeasons } from "../principals.js";
import { leagueFragility } from "../metrics/fragility.js";
import { performanceMetrics } from "../metrics/skill.js";
...
export async function computeAwards(h) {
  ...
  const perfSpecs = [
    ...
    },
    {
      ...
      subtitle:
        "Most fragile roster right now, by the Fragility Index: how much of the lineup is load-bearing on a handful of assets, and how little there is behind them. Not a verdict on quality - a torn-down roster can score low because it has little to lose, and the most torn-down rosters do not enter this ranking at all, because there is too little on them to read a score from.",
