 ...
 */
const ALLOWLIST = [/_next\/webpack-hmr/];
/**
...
export function expectNoConsoleErrors(guard) {
  expect(
    guard.errors,
 ...
 */
export async function expectStableChrome(page) {
 ...
 */
export async function primeLens(page, rosterId = 1) {
  await page
    .context()
    .addCookies([
