  ...
  return (
    <div>
        ...
        <div className="flex items-start gap-2.5">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-1 text-meta leading-relaxed text-muted">
              Claim links are generated per manager and handed out once. Copying
              one out of a chat window sometimes drops the tail of it, so paste
              the whole thing rather than clicking a wrapped line.
            </p>
          </div>
        </div>
      </div>
      ...
      <p className="mt-4 text-meta leading-relaxed text-muted">
        You do not need a link to look around. Everything Parquet shows about
        the league is public league data, and you can read all of it as any
        team.
      </p>
