...
export const metadata = {
  ...
  description:
    "Experimental surfaces. Reachable, unfinished, and honest about it.",
};
    ...
    <div>
      ...
      <Card className="mt-1">
        <p className="text-body leading-relaxed text-muted">
          A lab is where a claim gets tried before it gets made. Everything
          below is built on real league data, and every one of them can still be
          wrong: the method may not hold, the number may not mean what it looks
          like, and the page may be deleted in the next round rather than fixed.
        </p>
      ...
      <p className="mt-5 text-meta leading-snug text-secondary">
        The Lab sits one tap off the main path on purpose. It has a single entry
        on the full index and appears nowhere else, so an unfinished idea cannot
        crowd a finished one.
      </p>
      <Onward from="/lab" />
    </div>
  );
